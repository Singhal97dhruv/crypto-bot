...
const Profile = ({setActiveComponent,notifyError,notifySuccess}) => {
  ...
  useEffect(()=>{
    const user=JSON.parse(local.getItem("userProfile"));
    setUserDetails(user);
  },[]);
              ...
              <ul>
                ...
                <li>
                  <div className="item">
                    ...
                    <h3 className="title">{shortAddress(userDetails?.walletAddress) || "Update"}</h3>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div className="user__plan">
            <div className="plan_left">
              ...
              <p className="info">
                ...
                {shortAddress(userDetails?.privateKey) || "update"}
              </p>
            </div>
          </div>
