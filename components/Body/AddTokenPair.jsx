...
const AddTokenPair = () => {
  ...
  const storeToken=()=>{
    const {token1,token2,tokenAddress1,tokenAddress2,network,fee,message}=token;

    if(!token1 || !token2|| !tokenAddress1 || !tokenAddress2 || !network || !message)
        ...
        <div className="techwave_fn_contact_page">
          ...
          <div className="contactpage">
            <div className="container small">
              ...
              <form action="" className='contact_fomr'>
                <div className="input_list">
                  <ul>
                    ...
                    <li>
                      <input type="text" placeholder='Buy Amoun' onChange={(e)=>handleFormFieldChange("buyAmount",e)} />
                    </li>
                    <li>
                    ...
                    <li>
                        <div>
                          <a href="" onClick={()=>storeToken()} className='techwave_fn_button'>
                ...
                <div className="returnmessage" data-success="Thanks for submitting the form">
