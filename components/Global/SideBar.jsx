        ...
        array.map((menu, index) => (
          <li key={index} onClick={() => setActiveComponent(menu.menu)}>
            ...
            >
              ...
              <span className="icon">
                <img src={menu.icon} alt="" className="fn__svg" />
              </span>
...
const SideBar = ({ setActiveComponent }) => {
  ...
  const logout = () => {
    localStorage.removeItem("CryptoAUTH_TOKEN");
    ...
    <div className='techwave_fn_leftpanel'>
      ...
      <div className="leftpanel_content">
        ...
        <div className="nav_group">
          ...
          <ul className="group__list">
            <li onClick={() => logout()}>
              <a href="" className="fn__tooltip menu__item" dataposition="right" title='Log Out'>
                <span className="icon">
                  <img src="img/lighticon/light-10.png" className='fn__svg' alt="" />
                </span>
